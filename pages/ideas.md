...
Use this page as a running queue. Move items from `Idea` -> `Planned` -> `Added`.
...
- [ ] Peach Cobbler
- [ ] Apple Pie
- [ ] Chocolate Chip Cookies (Classic Toll House Style)
- [ ] Brownies (Fudgy)
- [ ] Chicken Pot Pie
- [ ] Macaroni Salad
...
- [ ] Sloppy Joes
- [ ] Meatloaf (classic home-style)
- [ ] Southern Fried Chicken (portion after cooking)
- [ ] Mashed Potatoes and Gravy
- [ ] Coleslaw (BBQ Style)
- [ ] Deviled Eggs
...
## Sauces and Copycat Ideas

- [ ] CopyKat Raising Cane's Sauce
- [ ] CopyKat Chick-fil-A Frosted Lemonade
- [ ] CopyKat Taco Bell Quesadilla Sauce
- [ ] Burger Special Sauce (House Blend)
- [ ] Sweet and Spicy BBQ Sauce
- [ ] CopyKat In-N-Out Spread
- [ ] CopyKat Whataburger Creamy Pepper Sauce
...
- [ ] Easter Deviled Egg Board
- [ ] Fourth of July Pasta Salad

## 30-Minute Meals

- [ ] Garlic Butter Chicken Bites with Green Beans
...
- [ ] Steak and Veggie Meal Prep Bowls
- [ ] Greek Yogurt Chicken Salad
- [ ] Protein Pasta with Turkey Meat Sauce
...
- [ ] CopyKat Panda Express Orange Chicken
- [ ] CopyKat KFC Famous Bowl
- [ ] CopyKat Taco Bell Crunchwrap
- [ ] CopyKat Starbucks Egg Bites
- [ ] CopyKat Texas Roadhouse Rolls
- [ ] CopyKat Panera Broccoli Cheddar Soup
- [ ] CopyKat Domino's Parmesan Bites
...
- [ ] No-Bake Banana Cream Pie Cups
- [ ] Oreo Icebox Cake

## Drinks and Mocktails

- [ ] Strawberry Lemonade
- [ ] Iced Vanilla Latte (Homemade)
- [ ] Sparkling Citrus Punch
- [ ] Arnold Palmer Pitcher
- [ ] Pineapple Ginger Fizz Mocktail

## Dips, Appetizers, and Snacks
...
- [ ] How to Build a Freezer Meal Kit
...
- [ ] Seafood Recipe Roundup

## By Occasion

- [ ] Weeknight Dinner Favorites
- [ ] Potluck Crowd-Pleasers
- [ ] Holiday Hosting Menu Plan
- [ ] Back-to-School Easy Meals
- [ ] Date Night at Home Menu

## Notes for future recipe adds

- Keep frontmatter consistent: `layout`, `title`, `image`, `tags`, `servings`, `prep_time`, `cook_time`, `total_time`.
- Prefer local image files in `/images` when available.
- Tag style to match current site patterns (example: `copycat mains dessert`).
